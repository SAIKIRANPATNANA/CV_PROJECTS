...
from signLanguagePractice.entity.config_entity import DataValidationConfig
from signLanguagePractice.entity.artifacts_entity import DataIngestionArtifact
from signLanguagePractice.entity.artifacts_entity import DataValidationArtifact
class DataValidation:
    def __init__(
            ...
            try:
                  ...
                  self.data_validation_config = data_validataion_config
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            logging.info("Exited from initiate_data_validation method of DataValidation class")
