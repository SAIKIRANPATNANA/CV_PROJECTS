...
from signLanguagePractice.constant.training_pipeline import *
...
class DataValidationConfig:
    data_validation_dir: str = os.path.join(
        training_pipeline_config.artifacts_dir, DATA_VALIDAION_DIR_NAME
    )
...
#     S3_MODEL_KEY_PATH = S3_MODEL_NAME
